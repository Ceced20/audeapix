...
const PACKAGES = [
  {
    id: "double", name: "Triplet Snap", shots: 3, slots: 3, prints: 1,
...
const TEMPLATES_DOUBLE = [
  ...
  },
  {
    ...
    slotDefs: [
      { x: 0.248, y: 0.133, w: 0.470, h: 0.117 },
      { x: 0.157, y: 0.387, w: 0.482, h: 0.127 },
      { x: 0.157, y: 0.648, w: 0.481, h: 0.117 },
    ],
    pngW: 707, pngH: 2000,
  },
  {
  ...
  return (
    <Screen>
      <div style={{ textAlign: "center", maxWidth: 620, zIndex: 1 }}>
        <p className="fade-up" style={{ fontFamily: "'Raleway',sans-serif", fontWeight: 300, letterSpacing: "0.4em", fontSize: 12, color: "#EB4233", marginBottom: 22, textTransform: "uppercase" }}>AUDEAPIX PHOTOBOOTH · EST. 2026</p>
