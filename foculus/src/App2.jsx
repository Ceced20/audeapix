...
const PACKAGES = [
  {
    ...
    icon: "✦",
    perks: [
      "3x kesempatan foto (pilih 2 terbaik)",
      "Soft file (PNG)",
      "1x lembar print (2 foto)",
    ],
  },
  {
    id: "quatre",
    ...
    popular: true,
    perks: [
      "5x kesempatan foto (pilih 4)",
      "Soft file (PNG)",
      "1x lembar print (4 foto)",
    ],
  },
  {
    id: "six",
    ...
    icon: "✦✦✦",
    perks: [
      "7x kesempatan foto (pilih 6)",
      "Soft file (PNG)",
      "2x lembar print (6 foto)",
    ],
  },
];
...
const TEMPLATES = [
  /* ── 3-SLOT (Double Snap) ── */
  { id: "t3a", slots: 2, name: "Foculus Red",    accent: "#EB4233", labelBg: "#8b1a10", stripBg: "#1a0400", overlay: "/templates/foculus-3slot.png" },
  { id: "t3b", slots: 2, name: "Scarlet Night",  accent: "#EB4233", labelBg: "#5a0a06", stripBg: "#0d0100", overlay: null },
  ...
  /* ── 7-SLOT (Six Snap) ── */
  { id: "t7a", slots: 6, name: "Foculus 2026",   accent: "#EB4233", labelBg: "#7a1208", stripBg: "#110200", overlay: "/templates/foculus-7slot.png" },
  { id: "t7b", slots: 6, name: "Mahogany",       accent: "#c07050", labelBg: "#2a100e", stripBg: "#0d0200", overlay: null },
];
